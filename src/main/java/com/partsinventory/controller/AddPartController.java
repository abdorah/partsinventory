...
public class AddPartController {
    ...
    @FXML
    private ComboBox<Category>partCategory ;
    ...
    void initialize() throws SQLException {
        ...
        partCategory.setConverter(new StringConverter<Category>() {
            @Override
    ...
    void savePart(ActionEvent event) {
        ...
        Part part = new Part(0,partNameField.getText() , partMakerField.getValue().toString(), partDescriptionField.getText(),
                Float.parseFloat(partPriceField.getText()), Integer.parseInt(partQuantityField.getText()),selectedCategory);
